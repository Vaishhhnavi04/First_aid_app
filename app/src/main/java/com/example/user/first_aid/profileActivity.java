...
public class profileActivity extends AppCompatActivity {
    ...
    void showDetails(String topicName){
        ...
        if(topicName.equals("Anxiety")){

            imageView.setImageResource(R.drawable.anx);
            textView.setText(R.string.Anxiety);

        }

       /* if(topicName.equals("Grief")){

            imageView.setImageResource(R.drawable.grief);
            textView.setText(R.string.Grief);
